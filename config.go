...
var defaultConfig = &Config{
	...
	OutDirPath:        "history",
	DoAccountDump:     false,
	DoContactsDump:    false,
	DoSessionsDump:    false,
}
...
type ConfigRaw struct {
	...
	DoAccountDump     bool            `json:"dump_account"`
	DoContactsDump    bool            `json:"dump_contacts"`
	DoSessionsDump    bool            `json:"dump_sessions"`
}
